...
| [13 段录屏与讲稿](https://zcimon57-svj.github.io/databricks-lakehouse-agent-demo/site/details/recordings.html) | 演示人、培训和复盘 | 13 段中文有声版、13 段无声原版、时长和讲解重点 |
...
- 11 段真实 AWS Databricks Free Edition 工作区录屏和 2 段本地架构演示；
- 13 段普通话有声 MP4，共 62 个按画面转场对齐的解说片段；
- 6 张可离线展示的 SVG 架构图；
...
配音媒体校验结果见 [中文配音校验记录](evidence/workspace/zh-voiceover-validation.md)。有声版为合成神经语音，不冒充真人录音；无声原版保持不变。

## 证据边界

- 账号与功能验证是 2026-08-18 的 Free Edition 快照，不代表当前商业版权益、SLA、容量、网络、合规或成本；
- G3 和 D1 是明确标注的架构演示，不冒充该账号中的生产 API 或云数据库实调；
...
docs/                  完整研究稿、项目约定与来源
videos/recordings/     13 段无声原版与 zh-voice/ 中文有声版
